...
def dataset(fpath):
    ...
    if fpath.split("/")[-1]=="train":
        im_thresh = 500 #optimum 5000
        type2_num = 20000 #optimum 200000
        type1_num = 10000 #optimum 100000
    elif fpath.split("/")[-1]=="test":
        im_thresh = 150 #optimum 1500
        type1_num = 1000 #optimum 10000
        type2_num = 1000 #optimum 10000
